...
from clarion.hosted.config import settings
from clarion.hosted.database import HostedDatabase
from clarion.hosted.live_bus import LiveEvent, LiveEventBus
from clarion.hosted.services.streams import HostedStreamService
from clarion.hosted.telegram_bot import start_in_thread as start_telegram_listener
from clarion.hosted.user_settings import UserSettings
...
logger = get_logger("clarion.hosted.monitor")
...
class HostedMonitor:
    ...
    async def run(self) -> None:
        logger.info("Starting hosted Clarion supervisor")
