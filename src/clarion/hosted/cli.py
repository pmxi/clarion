...
from clarion.hosted.web.app import run as run_web
from clarion.hosted.worker import main as run_worker
...
def cmd_init(_args: Namespace) -> None:
    ...
    print("  - Start worker: clarion-hosted worker")
    print("  - Start web:    clarion-hosted web")
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(prog="clarion-hosted")
